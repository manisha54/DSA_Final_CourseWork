...
k = int(input("number of linked list: ")) #Taking input for number of kth linked list
mergeLinkedList = LinkedList() #initializing LinkedList which is final Merged Linked List
...
for i in range(k):
    ...
    mergeLinkedList.head = Merge(mergeLinkedList.head, li.head) #Merging Linked List
    
sortAndGetMedian(mergeLinkedList) #calling function to get median of mergedLinkList